%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%molcggdfitexact : fits a generalized gamma PDF to data using the method of 
%log-cumulants.
%
%
%g = molcggdfitexact(x,d) evaluates the generalized gamma distribution at the 
%points in x, using the method of log-cumulants. Ref.: [Li et al., 2011]
%
%INPUT
...
function g = molcggdfitexact(x,k)
