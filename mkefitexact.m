...
%
%f = mkefitexact(x, k, N) evaluates the fitted PDF at the points in x.
%The output is the series expansion of the log-normal PDF based on log-
%cumulants k, introduced by Pastor (2014, 2016). The highest order 
%log-cumulant used is N.
%
%INPUT
